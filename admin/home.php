...
<h1>Ласкаво просимо до <?php echo $_settings->info('name') ?> </h1>
...
<div class="row">
    <div class="col-12 col-sm-12 col-md-6 col-lg-4">
        <div class="info-box bg-gradient-light shadow">
            ...
            <span class="info-box-text">Активні земельні ділянки</span>
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-4">
        <div class="info-box bg-gradient-light shadow">
            ...
            <div class="info-box-content">
            <span class="info-box-text">Активні облікові записи</span>
            <span class="info-box-number text-right">
                <?php 
    ...
    <div class="col-12 col-sm-12 col-md-6 col-lg-4">
        <div class="info-box bg-gradient-light shadow">
            ...
            <div class="info-box-content">
            <span class="info-box-text">Записи в журналі</span>
            <span class="info-box-number text-right">
                <?php 
