...
<?php require_once('inc/header.php') ?>
  ...
  <div class="modal fade" id="confirm_modal" role='dialog'>
    <div class="modal-dialog modal-md modal-dialog-centered rounded-0" role="document">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary btn-flat" id='confirm' onclick="">Продовжити</button>
        <button type="button" class="btn btn-secondary btn-flat" data-dismiss="modal">Закрити</button>
      </div>
      </div>
    </div>
  </div>
  <div class="modal fade rounded-0" id="uni_modal" role='dialog'>
    <div class="modal-dialog modal-md modal-dialog-centered rounded-0" role="document">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-primary btn-flat" id='submit' onclick="$('#uni_modal form').submit()">Зберегти</button>
        <button type="button" class="btn btn-secondary btn-flat" data-dismiss="modal">Назад</button>
      </div>
      </div>
    </div>
  </div>
