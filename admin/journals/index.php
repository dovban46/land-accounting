...
<div class="card card-outline card-primary">
	<div class="card-header">
		<h3 class="card-title">Записи в журналі</h3>
	</div>
	<div class="card-body">
					...
					<tr>
						...
						<th class="p-0">
							<div class="d-flex w-100">
								<div class="col-6 border">Власник</div>
								<div class="col-3 border">Податок</div>
							</div>
						</th>
						<th>Дія</th>
					</tr>
					...
					<tr>
						...
						<td class="text-center">
							...
							<div class="dropdown-menu" role="menu">
								...
								<a class="dropdown-item delete_data" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"  data-code="<?php echo $row['code'] ?>"><span class="fa fa-trash text-danger"></span> Видалити</a>
							</div>
						</td>
					</tr>
					<?php endwhile; ?>
...
<script>
	$(document).ready(function(){
		...
		$('.delete_data').click(function(){
			_conf("Ви впевнені, що хочете остаточно видалити цей запис журналу?","delete_book",[$(this).attr('data-id')])
		})
